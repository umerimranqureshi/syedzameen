...
<div class="container">
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form method="POST" class="form-group"  action="/dealerUpdate/{{$post->id}}" enctype="multipart/form-data">
                @csrf
                                                ...
                                                <div class="card-body" style="margin-left: 50px; margin-right: 50px;">
                                                    ...
                                                    <div class="col-sm-6 col-md-12">
                                                        ...
                                                        <div class="float-right form-group ">
                                                            ...
                                                            <input class="form-control" value="{{ $post->title }}" name="title" type="text" id="set_lenght_title" required>
                                                            ...
                                                            <input class="form-control" name="plot_size" value="{{ $post->plot_size }}" id="" rows="4">
                                                            ...
                                                            <img width="100" style="margin-bottom:9px" height="80" src="{{ asset('dealerimage/'.$post->image) }}" alt="" srcset="">                                                           
