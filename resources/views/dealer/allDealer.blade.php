              ...
              <table id="basic-datatable" class="table dt-responsive ">
                <thead>
                  <tr>
                    ...
                    <th>Own Payment</th>
                    <th>Down Payment</th>
                    <th>Last Own Payment</th>
                    <th>Last Down Payment</th>
                    <th>Notice Period</th>
                    <th>Society Picture</th>
                    <th>action</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$post->title}}</td>
                    <td>{{$post->selected_plot_sizes}}</td>
                    <td>{{$post->own_payment}}</td>
                    <td>{{$post->down_payment}}</td>
                    <td>{{$post->last_own_payment}}</td>
                    <td>{{$post->last_down_payment}}</td>
                    <td>{{$post->notice_period}}</td>
                    <td>
                    ...
                    <td>
                      <a onclick="return confirm('Are you sure you want to delete this item?')" href="{{url('deleteAdminSociety',['id'=>$post->id])}}" style="color: red;font-size:18px" class="mdi mdi-delete-forever"></a>
                      <a href="{{url('adminSocietyEdit',['id'=>$post->id])}}" style="color: gray;font-size:18px">
