...
<form id="main-search-form" method="GET" action="{{route('property.search')}}" class="adbanced-form-two amenities-list border-top-1-gray">
    ...
    <div class="row bg-light">
        ...
        <div class="form-group col-lg-3 col-md-12  col-sm-12 px-0 pt-md-15 ">
            ...
            <div class="btn-group btn-group-toggle  position-relative propBtns " style="width: 97%;margin-left: 3%" data-toggle="buttons">
                <label id="sale" style=" margin-top :15px;" class="btn btn-secondary " onclick="changecolor(id)">
                    <input type="radio" name="purpose" class="property_type margin hg" value="sale" />Sale
                </label>
        ...
        <div class="form-group mb-0 pb-15 col-lg-3 col-md-12 col-12">
            <div class="price_range">
                <div class="price-filter">
                    ...
                    <span><input id="filter_sqft" type="text" name="area" value="{{$old_area ?? "0;200"}}" />
                        <input type="" class="select form-control has-val" placehoder="0 to Any"></span>
