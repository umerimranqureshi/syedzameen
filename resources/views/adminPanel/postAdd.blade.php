    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form method="POST" class="form-group" action="{{route('addAdminPost')}}" enctype="multipart/form-data">
                ...
                <form method="POST" class="form-group" action="{{route('postadd')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 col-md-12">
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <div>
                                                            <label><input type="radio" name="property_type" class="property_type" value="residential"> Residential</label>
                                                            <label><input type="radio" name="property_type" class="property_type" value="commercial"> Commercial</label>
    ...
    *********************-->
        ...
        ********************* -->
                                                            ...
                                                            <div class="float-right form-group ">
                                                                ...
                                                                <div class="d-flex justify-content-center">
                                                                    ...
                                                                    <select class="form-control float-right" name="unit" id="">
                                                                        ...
                                                                        <option value="square_yards">Square yards
                                                                        </option>
                                                                    </select>
                    ...
                    <option value="2021">2021</option>
                                                                ...
                                                                <h5 class="mt-2 mb-2" id="electricity-backup">
                                                                    Electricity
                                                                    Backup:</h5>
                                                                <div class="d-flex justify-content-left">
                                                                    <div class="form-check">
                                                                ...
                                                                <div class="collapse" id="collapseExample1">
                                                                    ...
                                                                    <div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label fw-bolder" for="Desputed">Disputed
                                                                        </label>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="card">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <h4 class="card-subtitle mb-4">You Can
                                                                                    Select
                                                                                    Only One
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="card">
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <h5 class="card-title">Select Multiple Sub
                                                                                images:</h5>

                                                                            <p class="card-subtitle mb-4">Press Ctrl to
                                                                                select
                                                                                multiple
                                                                                images You can select only 30 Images
                                                                            </p>
