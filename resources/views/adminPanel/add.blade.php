                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            ...
                            <h4 class="mb-0 font-size-18">Add Manage </h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Syed Zameen</a></li>
                                    <li class="breadcrumb-item active">Add Manage</li>
                                </ol>
                    ...
                    @endif
                    <form method="POST" class="form-group" action="{{route('adminsaveadd')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <h5 class="mt-2 mb-2">Add Image</h5>
                                            ...
                                            <button class="btn btn-light w-100 shadow-sm bg-gradient" type="submit"
                                                style="background-color: #ff7f00;height: 60px;">Submit Add
                                            </button>
