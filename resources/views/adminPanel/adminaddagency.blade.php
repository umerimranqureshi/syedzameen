        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    @endif
                    <form method="POST" class="form-group" action="{{route('adminsaveagency')}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="" id="" name="name"
                                                type="text"><br>
                                            ...
                                            <input class="form-control" placeholder="" id="" name="url" type="text"><br>
                                            ...
                                            <button class="btn btn-light w-100 shadow-sm bg-gradient" type="submit"
                                                style="background-color: #ff7f00;height: 60px;">Submit Agency
                                            </button>
