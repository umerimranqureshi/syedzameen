...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <form method="POST" class="form-group" action="{{route('addSellerpost')}}" enctype="multipart/form-data">
                @else

                <form method="POST" class="form-group" action="{{url("post/add")}}" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body" style="margin-left: 50px; margin-right: 50px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <h5 class="mt-2 mb-2">Purpose:</h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <label><input type="radio" name="purpose" value="sale">For Sale </label>
                                                            <label><input type="radio" name="purpose" value="rent">For Rent </label>
                                                        </div>
                                                    </div>
                                                    </div><br>
                                                    ...
                                                    <select class="form-control" name="property_type" id="property_type" onchange="handChangeColor(this.id)">
                                                    ...
                                                    <select class="form-control" name="sub_type" id="sub_type" onchange="handChangeColor(this.id)">
                                                    ...
                                                    <select class="form-control mt-1" name="sub_type_plot" id="sub_type_plot" onchange="handChangeColor(this.id)">
                                                        ...
                                                        <option value="commercial_land">agricultural land</option>

                                                    </select>

                                                    </select>

                                                    <select class="form-control mt-1" name="sub_type_type" id="sub_type_type" onchange="handChangeColor(this.id)">
                                                    ...
                                                    <select id="location" class="form-control select22" name="city_area" onchange="handChangeColor(this.city.  id)">
                                        ...
                                        <div class="card-body" style="margin-left: 50px; margin-right: 50px;">
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                ...
                                                <div class="float-right form-group ">
                                                    ...
                                                    <input class="form-control" name="property_title" type="text" id="set_lenght_title" required>
    ...
    *********************-->
        ...
        ********************* -->
                                        ...
                                        <div class="card-body" style="margin-left: 50px; margin-right: 50px;">
                                            ...
                                            <div class="col-sm-6 col-md-12">
                                                ...
                                                <div class="float-right form-group ">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <input class="form-control" name="year" id="" type="number">
                    ...
                    <option value="2021">2021</option>
                                                    ...
                                                    <h5 class="mt-2 mb-2" id="electricity-backup">Electricity Backup:</h5>
                                                    <div class="d-flex justify-content-left">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"  value="generator" name="floaring[]"id="generator">
                                                    ...
                                                    <div class="d-flex justify-content-left">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"  value="UPS" name="floaring[]"id="UPS">
                                                    ...
                                                    <div class="d-flex justify-content-left">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"  value="solar" name="floaring[]" id="solar">
                                                    ...
                                                    <div class="d-flex justify-content-left">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"  value="other" name="floaring[]" id="other">
                                                    ...
                                                    <div class="collapse" id="collapseExample">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="maintaincestaff" id="maintenance-staff">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="securitystaff" id="Security-Staff">
                                                            <label class="form-check-label fw-bolder" for="Security-Staff">Security Staff
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="drawingroom" id="Drawing-Room">
                                                            <label class="form-check-label fw-bolder" for="Drawing-Room">Drawing Room
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="diningroom" id="Dining-Room">
                                                            <label class="form-check-label fw-bolder" for="Dining-Room">Dining Room
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="prayerroom" id="Prayer-Room">
                                                            <label class="form-check-label fw-bolder" for="Prayer-Room">Prayer Room
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="powderroom" id="Powder-Room">
                                                            <label class="form-check-label fw-bolder" for="Powder-Room">Powder Room
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="tvlounge" id="TV-lounge">
                                                            <label class="form-check-label fw-bolder" for="TV-lounge">TV lounge
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="sittingroom" id="Sitting-room">
                                                            <label class="form-check-label fw-bolder" for="Sitting-room">Sitting room
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="neartoschools" id="Near-to-schools">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="neartohospitals" id="Near-to-hospitals">
                                                    ...
                                                    <div class="collapse" id="collapseExample1">
                                                        <div class="form-check mt-3">
                                                            <input class="form-check-input" type="checkbox" value="possession" id="Possession">
                                                            <label class="form-check-label fw-bold" for="Possession">Possession
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="corner" id="Corner">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="park-facing" id="Park-Facing">
                                                            <label class="form-check-label fw-bolder" for="Park-Facing">Park Facing
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="desputed" id="Desputed">
                                                            <label class="form-check-label fw-bolder" for="Desputed">Desputed
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="file" id="File">
                                                            <label class="form-check-label fw-bolder" for="File">File
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="electricity" id="Electricity">
                                                            <label class="form-check-label fw-bolder" for="Electricity">Electricity
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="severage" id="Severage">
                                                            <label class="form-check-label fw-bolder" for="Severage">Severage
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="water-supply" id="Water-Supply">
                                                            <label class="form-check-label fw-bolder" for="Water-Supply">Water Supply
                                                            </label>
                                                        </div>

                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="sui-gas" id="Sui-Gas">
...
********************* -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 col-md-12 ">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" style="text-transform:lowercase;" placeholder="https://www.youtube.com/channel/UCZvWbwDZetQNCznvHZeZRjw" id="" name="video_link" type="text">
                         ...
                         id="amenities" name="amenities" type="text"> -->
                                                                ...
                                                                <input class="form-control" id="contact_person_name" name="contact_person_name" value=" {{ auth()->user()->contact_person_name}}" type="text">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    <select style="border-style: solid; border-width: 1px;">
                                                                        <option style="background-image:url(https://img.icons8.com/color/32/000000/pakistan.png);"> +92</option>
                                                                    </select>
                                                                    <input id="mobile_number" name="mobile_number" value=" {{ auth()->user()->mobile_number }}" type="text" class="form-control" aria-label="Text input with dropdown button">
                                                                </div>
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input id="mobile_number" name="mobile2_number" value=" {{ auth()->user()->mobile2_number }}" type="text" class="form-control" aria-label="Text input with dropdown button">
                                                                </div>
                                                                <span class=" bg-warning text-dark" id="error-mobile2"></span>

                                                                <h5 class="mt-2 mb-2">Email</h5>
                                                                <input class="form-control" name="email" value=" {{ auth()->user()->email }}" type="text"></input>
                                                                @if ($errors->hasBag('addPostError'))
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-4">
                                                ...
                                                <div class="mx-auto" style="width: 200px">
                                                    ...
                                                    <button class="btn btn-light w-100 shadow-sm bg-gradient" type="submit" style="background-color: #ff7f00;height: 60px;">Submit Property</button>
        ...
        <script>
            function loadfile(event) {
                ...
                for (let i = 0; i <= z; i++) {
                    ...
                    $('#output').append("<div class='col-md-2 currentimgdiv" + i + "'> <button type='button' onclick='removeitem(" + i + ")' class='btn btn-danger pull-left'>x</button> <img style='max-width:140px; height: auto' src='" + URL.createObjectURL(event.target.files[i]) + "'></div>");
