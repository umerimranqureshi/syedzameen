              ...
              <table id="basic-datatable" class="table dt-responsive ">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="width:7%"><a href="{{route('sellerDisable',['id'=>$post->id])}}" style="color:{{($post->disable==1)?'grey':'green'}};font-size:18px" title="{{($post->disable==1)?'enable':'disbale'}}"><i class="fas fa-ban"></i></a>

                      <a onclick="return confirm('Are you sure you want to delete this item?')" href="{{route('deletePost',['id'=>$post->id])}}" style="color: red;font-size:18px" class="mdi mdi-delete-forever"></a>
