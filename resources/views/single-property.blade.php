...
<section>
	<div class="container">
		<div class="sidebar-widget bg-white  shadow py-40 px-30 mb-30" style="width: 100%">
			<div class="row ">
				<div class="col-lg-10 col-md-8 ">

					<div class="single-property position-relative">
	
						<span class="bg-secondary color-white z-index-1 px-15 py-5 mr-20">{{strtoupper($post->propertyCate->purpose)}}
			...
			<div class="product-slider">
				<div class="tab-content">
						 ...
						 <div class="container">
                                <div class="row align-items-start">
                                    {{-- <div class="col-sm-12  col-md-8 ">
										...
										<img style=" position: relative;  width: 100%;height: 450px;" src="{{asset('mainimage/'.$post->mainimage)}}" alt="slide">
										@else
										<img style=" position: relative;  width: 100%;height: 450px;" src="{{asset('mainimage/'.$post->mainimage)}}" alt="slide">
                                       ...
                                       <div class="col-sm-12  col-md-8 ">
                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img style=" position: relative;  width: 100%;height: 450px;"
                                                        class="d-block w-100" src="{{asset('mainimage/'.$post->mainimage)}}"
                                                        alt="First slide">
                                                </div>
                                                @foreach ($post->postImages as $image)
                                        ...
                                        <div class="sidebar-widget bg-white  shadow py-20 px-20">
                                            ...
                                            <form id="sendMessageForm" class="mt-30">
                                                <div class="row m-0">
                                                    ...
                                                    <div class="col-lg-12 p-1">
														<button type="submit"
                                                            class="btn btn-secondary w-100 {{ Auth::id() == $post->user->id ? 'disabled' : '' }}">Send
                                                            Message
														</button>
													</div>
													<div class="col-lg-12 p-1">
					...
					<div class="tab-pane " id="profile" role="tabpanel" aria-labelledby="profile-tab" >
						<div class="container">
							<div id="map" class="canvas" style="height: 500px;margin: 63px 0px 0px 0px; width: 100%;" class="sidebar-widget bg-white  shadow py-40 px-30 mb-30"></div>
						</div>
					</div>
	...
	<div class="container">
		<div class="row  " style="" > 
			<div class="col-md-12 col-lg-12">
				<div class="sidebar-widget bg-white  shadow py-40 px-30 mb-30">
			...
			<div class="col-md-12 col-lg-4">
				<div class="sidebar-widget bg-white  shadow py-40 px-30 mb-30">
					...
					<div class="row">
						...
						<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-bed icon-size"></i> Bedrooms
								<span class="float-right">{{$post->bedrooms}}</span></b></div>


						{{-- <div class="col-md-12 ">Orienten : <span  class="float-right">East</span></div> --}}
						<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-bath icon-size"></i> Bathrooms :
								<span  class="float-right">{{$post->bathrooms}}</span></b></div>
						{{-- <div class="col-md-12 ">Type : <span  class="float-right">Private House</span></div> --}}
						@endif
						<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-user icon-size"></i> contact person name :
								<span  class="float-right">{{$post->contact_person_name}}</span></b></div>
						<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-user icon-size"></i> Property Type :
								<span  class="float-right">{{$post->propertyCate->property_type}}</span></b></div>
						<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-user icon-size"></i> Property Sub Type :
								<span  class="float-right">{{$post->propertyCate->property_sub_type}}</span></b></div>
					</div>
					<div class="row">
						
							{{-- <ul class="list-by-tag hover-secondery-primary"> --}}
								<div class="col-md-12 "><b><i class="fa fa-plus-square icon-size"></i> Land Area :
										<span  class="float-right">{{$post->land_area." ". $post->unit." Marla" }} </span></b></div>

								<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-car icon-size"></i> Garage : <span  class="float-right">1</span></b>
								</div>
								<div class="col-md-12 "><b><i style="font-size: 20px" class="fa fa-clock-o icon-size"></i> Post Timings :
									<span  class="float-right">{{$post->created_at->diffForHumans()}}</span></b>
								</div>

								{{-- <div class="col-md-12 ">Plot size : <span  class="float-right">300x200x300</span></div> --}}
								{{-- <div class="col-md-12 ">Kitchens : <span  class="float-right">2</span></div> --}}
					</div>
				</div>
			</div>
			<div class="col-md-12 col-lg-4">
						...
						<a class="color-secondary mb-5" href="{{route('singlePage',['title'=>str_replace(' ', '-', $post->property_title),'id'=>$postL->id])}}">
							<div class="property-item">
								<div class="property-img position-relative overflow-hidden overlay-secondary-4">
									...
									<a class="color-secondary mb-5" href="{{route('singlePage',['title'=>str_replace(' ', '-', $post->property_title),'id'=>$postL->id])}}">
										<img src="{{$postL->mainimage?asset('mainimage/'.$postL->mainimage):asset('houseLog.jpg') }}" style="height: 200px">
									</a>
								...
								<div class="property-content bg-white pt-30 pb-50">
									<a class="color-secondary mb-5 " style="min-height: 100px;" href="{{route('singlePage',['title'=>str_replace(' ', '-', $post->property_title),'id'=>$postL->id])}}">
										<h5>{{$postL->property_title}}</h5>
									</a>
									<a class="color-dark mb-5" href="{{route('singlePage',['title'=>str_replace(' ', '-', $post->property_title),'id'=>$postL->id])}}">
