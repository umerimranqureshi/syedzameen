        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8">
                                ...
                                <div class="single-property position-relative">
                                    ...
                                    <ul class="property-features icon-primary d-table f-14 mt-15">
                                        <li><i style="font-size: 20px" class="fa fa-area-chart"></i>{{ $post->land_area }}
                                            Marla</li>
                                        <li><i style="font-size: 20px" class="fa fa-bed"></i>{{ $post->bedrooms }}
                                            Bedrooms
                                        </li>
                                        <li><i style="font-size: 20px" class="fa fa-bath"></i>{{ $post->bathrooms }}
                                            Bathrooms
                                        </li>
                                    ...
                                    <ul class="hover-option icon-white z-index-1 position-relative mt-md-30"
                                        ...
                                        <li>
                                            ...
                                            <a data-toggle="tooltip" data-placement="top"
                                                @if ($favPost->isNotEmpty()) @foreach ($favPost as $fav)
                                                ...
                                                @endforeach
                                                @endif
                                                @if ($favPost->isEmpty() && Auth::check()) class="fav-heart "
													title="wishlist" @endif
                    ...
                    <div class="product-slider">
                        <div class="tab-content">
                            <div class="tab-pane active position-relative" id="home" role="tabpanel"
                                        ...
                                        <div class="col-sm-12  col-md-12 ">
                                            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                                ...
                                                <a class="carousel-control-prev" href="#carouselExampleControls"
                                                    ...
                                                    <span class="sr-only" style="color:#2f77ad">Previous</span>
                                                </a>
                                                <a class="carousel-control-next" href="#carouselExampleControls"
                                                    role="button" data-slide="next" style="color:#2f77ad">
                                ...
                                <div class="tab-pane" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div id="map" class="canvas"
                                        style="height: 500px;margin: 63px 0px 0px 0px; border-radius: 25px;">
                                    </div>
                                ...
                                <div class="tab-pane" id="messages" role="tabpanel" aria-labelledby="messages-tab">
                                    ...
                                    <script async defer
                                        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBFdIgZTDOYWsZZ2MQzBLk49K2xFnLmI1s&libraries=places&callback=initMap">
                                    </script>
                ...
                <div class="col-sm-12  col-md-4 ">
                    <div class="sidebar-widget bg-white  shadow py-40 px-30" style="    position: sticky; top: 115px;">
                        ...
                        <form id="sendMessageForm" class="mt-30">
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="hidden" name="reciver_id" value="{{ $post->user->id }}"
                                        id="">
                            ...
                            <button type="button" class="btn btn-success w-100" data-toggle="modal"
                                data-target="#callModal1" data-id="{{ $post->id }}" class="toggle-class">
                                Call
                            </button><br>

                            <br><button type="button " class="btn btn-secondary  w-100 " data-toggle="modal"
                                data-target="#emailModal1" data-id="{{ $post->id }}" class="toggle-class">
                                Email
                            </button>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <ul class="list-by-tag">
                                    ...
                                    @endif
                                    <li><b><i style="font-size: 20px" class="fa fa-user icon-size"></i> contact person
                                            name :
                                    ...
                                    <li><b><i style="font-size: 20px" class="fa fa-user icon-size"></i> Property Sub
                                            Type :
                            ...
                            <div class="col-md-12 col-lg-6">
                                <ul class="list-by-tag hover-secondery-primary">
                                    <li><b><i class="fa fa-plus-square icon-size"></i> Land Area :
                                            <span>{{ $post->land_area . ' ' . $post->unit . ' Marla' }} </span></b>
                                    </li>

                                    <li><b><i style="font-size: 20px" class="fa fa-car icon-size"></i> Garage :
                                            <span>1</span></b>
                                    </li>
                                    <li><b><i style="font-size: 20px" class="fa fa-clock-o icon-size"></i> Post Timings :
                                            <span>{{ $post->created_at->diffForHumans() }}</span></b>
                                    </li>
                                ...
                                <ul class="single-property-amenities icon-primary my-20">
                                    ...
                                    @foreach ($helper::stringSeperatedByCommaToArray($post->amenities) as $amenitie)
                                        ...
                                        @if ($amenitie == 'furnished')
                                            ...
                                            <li><i class="fal fa-square" aria-hidden="true"></i> {{ $amenitie }}
                                            </li>
                                        @endif
                                        ...
                                        @if ($amenitie == 'Drawing-Room')
                                            ...
                                            <li><i class="fa fa-home" aria-hidden="true"></i> {{ $amenitie }}
                                            </li>
                                        @endif
                                        ...
                                        @if ($amenitie == 'Near-to-hospitals')
                                            ...
                                            <li><i class="fa fa-hospital-o" aria-hidden="true"></i>
                                                {{ $amenitie }}</li>
                                        @endif
                                        ...
                                        @if ($amenitie == 'Park-Facing')
                                            ...
                                            <li><i class="fa fa-tree" aria-hidden="true"></i> {{ $amenitie }}
                                            </li>
                                        @endif
                                        ...
                                        @if ($amenitie == 'File')
                                            ...
                                            <li><i class="fa fa-envelope" aria-hidden="true"></i> {{ $amenitie }}
                                            </li>
                                        @endif

                                        @if ($amenitie == 'Electricity')

                                            <li><i class="fa-solid fa-bolt" aria-hidden="true"></i>
                                                {{ $amenitie }}</li>
                                        @endif

                                        @if ($amenitie == 'Severage')

                                            <li><i class="fa fa-water" aria-hidden="true"></i> {{ $amenitie }}
                                            </li>
                                        @endif
                    ...
                    @else
                        <div class="border-top-1-gray py-30">
                            ...
                            <div class="property-video bg-img-3 position-relative">
                                ...
                                <iframe id="iframe_youtube" style="position: relative; height: 100%; width: 100%;"
                                ...
                                <div class="property-item">
                                    <div class="property-img position-relative overflow-hidden overlay-secondary-4">
                                        ...
                                        <ul class="hover-option position-absolute icon-primary z-index-1">
                                            <li>
                                                <a data-toggle="tooltip" data-placement="top"
                                                    @foreach ($favAllPost as $fav) @if ($fav->user_id == Auth::id() && $postL->favPostUser->count() > 0 && $fav->post_id == $postL->id)
