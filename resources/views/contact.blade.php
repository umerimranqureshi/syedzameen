...
<div class="page-banner overlay-black  mobile-responsive-header" style="padding: 150px 0 ; margin-top: -90px;" >
	<div class="container h-100">
		<div class="row h-100 align-items-center">
			<div class="col-lg-12">
				<h1 class="page-banner-title color-primary">Our Services </h1>
				<div class="text-area w-50 mt-15 color-white">
					<p>We provide best services to our clients. Trust us to find your living. For any information you can <a style="color: whitesmoke" href="#">Contact Us.</a></p>
				</div>
			</div>
		</div>
	</div>
