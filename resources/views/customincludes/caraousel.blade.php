<section style="margin-top: -150px;margin-bottom: -132px;">
    <div class="container">
            </div>
                                                    ...
                                                    <div class="hover-content py-30 px-20 overlay-hover-gradient">
                                                        <div class="thumbnail-title z-index-1 position-relative">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li><span
                                                                        class="color-primary">{{ $post->land_area }}</span>Marla
                                                                </li>
                                                                <li><span
                                                                        class="color-primary">{{ $post->bedrooms }}</span>bedrooms
                                                                </li>
                                                                {{-- <li><span
                                                                        class="color-primary">{{ $post->bathrooms }}</span>bathrooms
                                                                </li> --}}
