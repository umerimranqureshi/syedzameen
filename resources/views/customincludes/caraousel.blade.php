                        ...
                        <div class="col-md-4 col-sm-6 mb-4">
                            ...
                            <div class="property-thumbnail mt-30">
                                ...
                                <div class="property-img position-relative overflow-hidden overlay-secondary-4"
                                    ...
                                    <img src="{{$post->mainimage?(file_exists('mainimage/'.$post->mainimage)?asset('mainimage/'.$post->mainimage):asset('houseLog.jpg')):asset('houseLog.jpg') }}"
                                    ...
                                    <div class="thumbnail-content z-index-1 color-white-a color-white">
                                        ...
                                        <ul class="hover-option position-absolute icon-white z-index-1">
                                            <li>
                                                <a data-toggle="tooltip" data-placement="top"
                                                    class="bg-secondary fav-phone" title="" href="tel:+923328447174"
                                                    class="color-white" data-original-title="Call">
                                                    <i class="fa fa-phone" aria-hidden="true"></i></a>
                                            </li>
                                            {{-- <li>
                                                <a data-toggle="tooltip" data-placement="top"
                                                    class="bg-danger fav-heart" title=""
                                                    href="https://syedzameen.com/public/fav/post/add/{{$post->id}}"
                                                    data-original-title="remove wishlist">
                                                    <i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                            </li>
                                            <li>
                                                <a data-toggle="tooltip" data-placement="top" title="" href="#"
                                                    data-original-title="Compare"><i class="fa fa-random"
                                        ...
                                        <div class="hover-content py-30 px-20 overlay-hover-gradient">
                                            <div class="thumbnail-title z-index-1 position-relative">
                                                ...
                                                @endphp
                                                <span
                                                    class="thumbnail-price bg-dark color-secondary px-15 mb-10 d-table">
                                                    RS {{$formattedPrice}}</span>
                                                <a class="color-secondary mb-5"
                                                    ...
                                                    <span class="address icon-primary f-14"><i
                                                            class="fa fa-map-marker"></i>{{ $post->area }}
                                                    </span>
                                                ...
                                                <ul
                                                    ...
                                                    {{-- <li><span class="color-primary">{{ $post->bathrooms
                                                            }}</span>bathrooms
                                                    </li> --}}
...
<!-- <script>
            const xyz = document.getElementById("convert")
            debugger

            function numDifferentiation(value) {
                var convt = document.getElementById('convrt')
                debugger
