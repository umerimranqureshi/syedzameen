...
class mainController extends Controller
{
    public function indexView()
    {
        ...
        return view('index', compact('allPost', 'subtypee', 'cities', 'agencies', 'alllocation', 'showReallatestPost2', 'showReallatestPost', 'latestPost', 'showlatestPost2', 'showlatestPost', 'adminPost', 'featureAgencies', 'favPost', "allSoldProperty", "allPostNumber", "allAgentNumber", "specialPost"));
    }
    ...
    public function rentResidentialView()
    {
        ...
        return view('rent.residential', compact("allRCP", "subtypee", "cities", "favPost"));
    }
    ...
    public function rentCommercialView()
    {
        ...
        return view('rent.search', compact('allRCP', "subtypee", "cities", "favPost"));
    }
    ...
    public function saleResidentialView()
    {
        ...
        return view('sale.residential', compact("allRCP", "subtypee", "cities", "favPost"));
    }
    ...
    public function saleCommercialView()
    {
        ...
        $subtypee = DB::table("property_categories")->distinct()->get("property_sub_type");
        // dd($allRCP);
        return view('sale.commercial', compact('allRCP', "cities", "subtypee", "favPost"));
    }
   ...
   public function propertySearch(Request $req)
    ...
    public function searchAgency(Request $req)
    {
        ...
        return view("agncies", compact("allRCP", "old_agency_name", "old_city", "featureAgencies", 'latestPost', "cities", "favPost"));
    }
